...
public class ServiceManager {
    ...
    public ServiceManager(String address, String[] args) throws JIException, UnknownHostException
    {
        this.address = address;
        session = JISession.createSession(args[1],args[2],args[3]);
        session.useSessionSecurity(true);
        session.setGlobalSocketTimeout(50000);
...
//        String strQuery = "SELECT * FROM Win32_PerfFormattedData_PerfOS_Processor WHERE Name != '_Total'";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ServiceManager test = new ServiceManager(args[0],args);
...
//        Select * from Win32_NTLogEvent Where Logfile = 'Security' and TimeWritten > '20170208' and EventCode = '4768'
        test.performOp("Select * from Win32_NTLogEvent Where Logfile = 'Application'and TimeWritten > '20170822004705.032216-000' ");
        test.killme();
    }
}